...
public class DisjointSetTests {
    ...
    public void testDisjointSet1() {
        ...
        for (int i = 0; i < half; i++) {
            ...
            Assert.assertFalse(result.equals(i));
        }
        ...
        // union the second set and the first set and make sure the superset is created
        // properly
    ...
    public void testDisjointSet3() {
        ...
        DisjointSet.Item<Integer> i2 = items[2];
        DisjointSet.Item<Integer> i3 = items[3];
        i1 = DisjointSet.union(i1, item);
        System.out.println(i1);
        System.out.println(i2);
        i1 = DisjointSet.union(i1, i2);
        i1 = DisjointSet.union(i3, i1);
