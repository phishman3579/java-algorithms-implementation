...
/**
 * Stack. a stack is a last in, first out (LIFO) abstract data type and linear data structure. A stack can have 
 * any abstract data type as an element, but is characterized by two fundamental operations, called push and pop. 
 * The push operation adds a new item to the top of the stack, or initializes the stack if it is empty. If the stack 
 * is full and does not contain enough space to accept the given item, the stack is then considered to be in an 
